...
// @updateURL    https://raw.githubusercontent.com/h-junior/userscripts/refs/heads/main/spotify-visual-panel-remover/script.user.js
// @downloadURL  https://raw.githubusercontent.com/h-junior/userscripts/refs/heads/main/spotify-visual-panel-remover/script.user.js
// ==/UserScript==

(function () {
	"use strict";

	const XPATHS = ["//*[@id='main-view']/following-sibling::*"];
	...
	function findTarget() {
		for (const xpath of XPATHS) {
			try {
				...
				console.warn(
					`[Spotify visual panel remover] XPath ${xpath} failed: ${e}`
				);
			}
		}
		return null;
